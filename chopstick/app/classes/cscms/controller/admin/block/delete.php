<?php
namespace app\cscms\controller\admin\block;
...
use \app\cscms\model\controller\admin\block\delete as dataset_block;
...
class delete extends \app\controller_admin
{
    ...
    public function action_index($params)
    {
        ...
        {
            response::redirect(url::create('/cscms/admin/block/summary'));
        }
        $this->display();
    }
    // --------------------------------------------------------------------------------
    ...
    function display()
    {
        ...
        echo $this->render('cscms/controller/admin/block/delete/confirm.twig', $vars);
    }
}