...
use \app\cscms\model\controller\admin\composer\edit as dataset_composer;
use \app\cscms\model\recordset\composer_block as recordataset_composer_block;
...
class edit extends \app\controller_admin
{
    ...
    private function display()
    {
        ...
        echo $this->render('cscms/controller/admin/composer/edit/edit.twig', $vars);
    }
}