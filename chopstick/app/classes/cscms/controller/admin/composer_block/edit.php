...
use \app\cscms\model\controller\admin\composer_block\edit as dataset_composer_block;
...
class edit extends \app\controller_admin
{
    ...
    public function action_index($params)
    {
        ...
        {
            response::redirect(url::create('/cscms/admin/composer_block/summary'));
        }
        $this->display();
    }
    // --------------------------------------------------------------------------------
    ...
    public function display()
    {
        ...
        echo $this->render('cscms/controller/admin/composer_block/edit/edit.twig', $vars);
    }
}