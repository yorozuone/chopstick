...
use \app\cscms\model\controller\admin\composer_block\delete as dataset_composer_block;
...
class delete extends \app\controller_admin
{
    ...
    function display()
    {
        ...
        echo $this->render('cscms/controller/admin/composer_block/delete/confirm.twig', $vars);
    }
}