...
// dataset
use \app\cscms\model\dataset\media\edit as dset_media;
...
class edit extends \app\controller_admin
{
    ...
    public function action_index($params)
    {
        ...
        {
            response::redirect(url::create('/cscms/admin/mediafolder/media/summary'));
        }
        $this->display();
    }
    // --------------------------------------------------------------------------------
    ...
    public function display()
    {
        ...
        echo $this->render('cscms/controller/admin/media/edit/edit.twig', $vars);
    }
}