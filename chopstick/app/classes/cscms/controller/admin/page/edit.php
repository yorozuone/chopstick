...
// dataset
use \app\cscms\model\controller\admin\page\edit as dataset_page;
...
class edit extends \app\controller_admin
{
    ...
    public function action_index($params)
    {
        ...
        {
            response::redirect(url::create('/cscms/admin/page/summary'));
        }
        // ------------------------------------------------------------
        // コンポーザー・ブロック情報取得
        // ------------------------------------------------------------
    ...
    public function action_update($params)
    {
        ...
        if ($is_valid)
        {
            ...
            response::redirect(url::create('/cscms/admin/page/summary', array($this->dataset_page->get_value('parent_page_id'))));
        }
        else
        {
            $this->display();
    ...
    public function display()
    {
        ...
        (
            ...
            //
            'rs_page_tree'        => \app\cscms\model\recordset\page::fetch_tree(),
            'rs_media'            => \app\cscms\model\recordset\media::fetch_all_page($this->dataset_page->get_value('page_id')),
            'rs_category_tree'    => \app\cscms\model\recordset\category::fetch_tree(),
            'rs_template'         => \app\cscms\model\recordset\template::fetch_all(),
        );
        ...
        echo $this->render('cscms/controller/admin/page/edit/edit.twig', $vars);
    }
}