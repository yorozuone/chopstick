...
// dataset
use \app\csroot\model\controller\admin\user\update_password as dset_user;

class update_password extends \app\controller_admin
{
    ...
    public function display()
    {
        ...
        echo $this->render('cscms/controller/admin/user/update_password/edit.twig', $vars);
    }
}