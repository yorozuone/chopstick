...
use \core\response;
use \core\url;
use \app\csroot\model\controller\admin\auth\login as dataset_login;
...
class login extends \app\controller
{
    ...
    function action_update()
    {
        ...
        if ($this->dataset_login->is_valid)
        {
            ...
            response::redirect(url::create('/csroot/admin/menu'));
        }
        $this->display();
    }
    // ********************************************************************************
    ...
    private function display()
    {
        ...
        echo $this->render('csroot/controller/admin/auth/login/edit.twig', $vars);
    }
}
